...
namespace Engine::ECS
{
	...
	std::vector<const Component*> EntityData::GetAllComponents() const
	{
		std::vector<const Component*> components = {};
		components.reserve(m_components.size());
		components.insert(components.begin(), m_components.begin(), m_components.end());
		return components;
	}
	...
	void EntityData::Serialize(Serialization::Serializer& serializer) const
	{
	}
	void EntityData::Deserialize(Serialization::Deserializer& deserializer)
	{
	}
