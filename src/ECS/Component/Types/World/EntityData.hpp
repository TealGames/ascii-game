...
namespace Engine::UI { class UITransformComponent; }
namespace Engine::ECS 
{ 
	using UITransformComponent = Engine::UI::UITransformComponent;
	...
	public:
		...
		template<typename ...ComponentT>
			requires ::Utils::AllSameBaseType<Component, ComponentT...>
		std::tuple<EntityData*, UITransformComponent*, ComponentT*...> CreateChildUI(const std::string& name, const TransformComponent& transform,
			const UITransformComponent& uitransform, const ComponentT&... components)
		{
			return CreateChild<UITransformComponent, ComponentT...>(name, transform, uitransform, components...);
		}
		template<typename ...ComponentT>
			requires ::Utils::AllSameBaseType<Component, ComponentT...>
		std::tuple<EntityData*, UITransformComponent*, ComponentT*...> CreateChildUI(const std::string& name, const ComponentT&... components)
		{
			return CreateChildUI<ComponentT...>(name, TransformComponent(), UITransformComponent(), components...);
		}
