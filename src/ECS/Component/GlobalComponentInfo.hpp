...
namespace Engine::ECS
{
	...
	public:
		ComponentInfo(const TypeCollection& dependentTypes, const ValidationAction& requiredAction, 
			const ComponentAddAction& postAddAction = nullptr);
		ComponentInfo(const DependencyType dependency, const TypeCollection& componentDependencies = {}, 
			const ComponentAddAction& postAddAction = nullptr);
	...
	namespace Utils
	{
		Component* AddOrGetComponentToEntityByName(EntityData& entity, const std::string& componentName);
	}
}
