...
using ComponentFieldVariant = std::variant<std::string*, int*, float*, std::uint8_t*, bool*, Vec2*, Vec2Int*, Color*>;
using ComponentFieldSetAction = std::variant<std::function<void(std::string)>, std::function<void(int)>, std::function<void(float)>, 
	std::function<void(std::uint8_t)>, std::function<void(bool)>, std::function<void(Vec2)>, std::function<void(Vec2Int)>, std::function<void(Color)>>;
