...
namespace Utils
{
	...
	{
		ENGINE_ASSERT(ray.m_Dir.IsUnitVector(), "Attempted to invoke RayIntersectsBounds but ray dir is not unit vector:{}", ray.m_Dir.ToString());
		Vec3 tMin, tMax;
		if (fabs(ray.m_Dir.m_X) < EPSILON)
		{
