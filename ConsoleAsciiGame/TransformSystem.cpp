...
namespace ECS
{
	...
	void TransformSystem::SetPos(TransformData& data, const Utils::Point2DInt& newPos)
	{
	...
	{
		SetPos(data, Utils::Point2DInt(newX, data.m_Pos.m_Y));
	}

	//TODO: do scene bound checking
	void TransformSystem::SetPosY(TransformData& data, const int& newY)
	{
		SetPos(data, Utils::Point2DInt(data.m_Pos.m_X, newY));
	}
	...
	void TransformSystem::SetPosDelta(TransformData& data, const Utils::Point2DInt& moveDelta)
	{
