...
RelativeGUIRect::RelativeGUIRect() : RelativeGUIRect(NormalizedPosition::TOP_LEFT, NormalizedPosition(1, 1)) {}
RelativeGUIRect::RelativeGUIRect(const NormalizedPosition& size) : RelativeGUIRect(NormalizedPosition::TOP_LEFT, size) {}
...
bool RelativeGUIRect::HasInvalidSize() const
{
...
void RelativeGUIRect::SetSize(const NormalizedPosition& size)
{
	...
	const RelativeGUIRect originalRect = *this;
...
{
	return std::format("[RelativeGUIRect topLeft:{} bottomRight:{} size:{}]", 
