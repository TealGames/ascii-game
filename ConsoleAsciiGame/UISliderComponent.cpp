...
UISliderComponent::UISliderComponent(const Input::InputManager& inputManager, const Vec2 minMaxValues, const GUIStyle& settings)
...
void UISliderComponent::SetSettings(const GUIStyle& settings)
{
	m_settings = settings;
}
